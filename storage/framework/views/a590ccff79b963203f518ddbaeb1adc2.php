<?php $__env->startSection('content'); ?>
								...
								<div class="container" data-aos="zoom-in">
												<div class="row">
																<div class="col-md-6 mt-5">
																				<div class="image_2">
																								<img src="<?php echo e(asset('assets/images/aboutus.jpg')); ?>" />
																				</div>
																</div>
																<div class="col-md-6">
				...
				<div class="services_section" data-aos="zoom-in" id="services">
								...
								<div class="row d-flex justify-content-center">
												<div class="col-lg-3 col-sm-6" data-aos="zoom-in">
																<div class="box_clients">
																				<img class="images_client" src="<?php echo e(asset('assets/images/dukaverse.png')); ?>" />
																</div>
																<p>DukaVerse</p>
												</div>
												<div class="col-lg-3 col-sm-6" data-aos="zoom-in">
																<div class="box_clients">
																				<img class="images_client" src="<?php echo e(asset('assets/images/mtaa.png')); ?>" />
																</div>
																<p>MtAa</p>
												</div>
												<div class="col-lg-3 col-sm-6" data-aos="zoom-in">
								...
								<div class="row d-flex justify-content-center">
												<div class="col-lg-3 col-sm-6" data-aos="zoom-in">
																<div class="box_clients">
																				<img class="images_client" src="<?php echo e(asset('assets/images/mobileapplication.png')); ?>" />
																</div>
																<p>Mobile Applications</p>
												</div>
												<div class="col-lg-3 col-sm-6" data-aos="zoom-in">
																<div class="box_clients">
																				<img class="images_client" src="<?php echo e(asset('assets/images/photography.png')); ?>" />
																</div>
																<p>Photography</p>
												</div>
												<div class="col-lg-3 col-sm-6" data-aos="zoom-in">
																<div class="box_clients">
																				<img class="images_client w-75" src="<?php echo e(asset('assets/images/hrsystem.png')); ?>" />
								...
								<div class="row d-flex justify-content-center">
												<div class="col-lg-3 col-sm-6" data-aos="zoom-in">
																<div class="box_clients">
																				<img class="images_client w-75" src="<?php echo e(asset('assets/images/ai.jpg')); ?>" />
												...
												<div class="col-lg-3 col-sm-6" data-aos="zoom-in">
																<div class="box_clients">
																				<img class="images_client w-75" src="<?php echo e(asset('assets/images/webapp.png')); ?>" />
												...
												<div class="col-lg-3 col-sm-6" data-aos="zoom-in">
																<div class="box_clients">
																				<img class="images_client w-75" src="<?php echo e(asset('assets/images/testanalysis.png')); ?> " />
																												...
																												<div class="row justify-content-center layout_padding">
																																...
																																<div class="col-md-6 col-xl-6">
																																				...
																																				<p class="there_text text-dark">
																																								I have worked with Storms Company and i am impresssed by their step by step cutomer
																																								involvement. They make the whole process seemless and easy. They also stick well to
																								...
																								<div class="carousel-item ">
																												<div class="row justify-content-center layout_padding" data-aos="zoom-in">
																																...
																																<div class="col-md-6">
																																				...
																																				<p class="there_text text-dark">
																																								I remember when i could not find a tech solution to employeee management. Storms
																																								came through and helped me. Not only did they help us get the best HR systems but
																								...
																								<div class="carousel-item">
																												<div class="row justify-content-center layout_padding" data-aos="flip-up">
																																...
																																<div class="col-md-6">
																																				...
																																				<p class="there_text text-dark">
																																								It is in good partnerships and goal oriented discussions that businesses thrive. We
				...
				<div class="contact_us_section layout_padding" id="contact">
								<div class="container">
												...
												<div class="row layout_padding">
																...
																<div class="col-md-6 col-xl mt-2">
																				<div class="mapouter">
																...
																<div class="col-md col-xl">
																				...
																				<div class="row ">
																								<div class="col-md-6 col-xl">
																												<p class="address_text1">Email : stormsco@storms.co.ke</p>
																												<p class="address_text1">Email : stormscompany@gmail.co.ke</p>
																								</div>
																								<div class="col-md-6 col-xl">
																												<p class="address_text1">Phone Number : +254714680763</p>
...
<?php echo $__env->make('layouts.welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\StormCompayWebsite\resources\views/index.blade.php ENDPATH**/ ?>