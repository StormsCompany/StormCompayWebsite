												...
												<nav class="navbar navbar-expand-lg">
																...
																<div class="collapse navbar-collapse" id="navbarSupportedContent">
																				...
																				<div class="form-inline search_icon">
																								<ul>
																												<li>
																																<a href="<?php echo e(route('login')); ?>"><img src="<?php echo e(asset('assets/images/user-icon.png')); ?>" />
																																				<tb>&ensp;Account
																																</a>
																												</li>
																...
																<div class="container">
																				<div id="main_slider" class="carousel slide" data-ride="carousel">
																																...
																																<div class="row" data-aos="flip-up">
																																				<div class="col-md-6">
																																								...
																																								<p class="there_text">
																																												...
																																												boardrooms where decisions are made we will inform you. We cover all your
																																												stories and give you more news anytime,anywhere and about everywhere from
																																												earth
																																												to the stars.
																																								</p>
																																								<div class="start_bt">
																								...
																								<a class="carousel-control-prev mt-2" href="#main_slider" role="button" data-slide="prev">
																												<i class="fa-arrow-left"><img src="<?php echo e(asset('assets/images/left-arrow.png')); ?>" /></i>
																								</a>
																								<a class="carousel-control-next mt-2" href="#main_slider" role="button" data-slide="next">
																												<i class="fa-angle-right"><img src="<?php echo e(asset('assets/images/right-arrow.png')); ?>" /></i>
																								</a>
																				</div>
																												...
																												<div class="col-lg-4 col-sm-12">
																																<div class="box_main">
																																				...
																																				<p class="many_text">
																																								...
																																								lightning-fast updates to keep you informed and on top of current events. Get
																																								real-time news, trending stories, and concise coverage across a wide range of
																...
																<div class="container">
																				<div class="row">
																								<div class="col-lg-3 col-sm-6">
																												...
																												<p class="footer_lorem_text">
																																Find the best customer service from us. We work and involve our customers throughought
																																the
																																development process.
																								...
																								<div class="col-lg-3 col-sm-6">
																												...
																												<div class="social_icon">
																																<ul>
																																				<li>
																																								<a href="#"><img src="<?php echo e(asset('assets/images/fb-icon.png')); ?>" /></a>
																																				</li>
																																				<li>
																																								<a href="#"><img
