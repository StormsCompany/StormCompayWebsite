...
<head>
				...
				<meta name="url" content="{{ config('app.url', 'https://storms.co.ke') }}">
				<meta name="description" content="{{ config('app.description', 'Your Tech Solution') }}">
				<meta name="author" content="{{ config('app.name', 'STORMS') }}">
				<!-- site metas -->
				<title>{{ config('app.name', 'STORMS') }} | Your Tech Solution</title>
				<!-- bootstrap css -->
																												...
																												<div class="col-lg-3 col-sm-6">
																																...
																																<div class="social_icon">
																																				<ul>
																																								<li>
																																												<a href="#"><img
																																																				src="{{ asset('assets/images/fb-icon.png') }}" /></a>
																																								</li>
																																								<li>
																																												<a href="#"><img
