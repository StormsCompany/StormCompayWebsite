...
@section('content')
				...
				<section class="login-content ">
								...
								<div class="col-md-8 col-xl-7 mx-auto">
												<form class="form-horizontal" id="regForm" action="{{ route('services.update', ['service' => $service->id]) }}"
																method="POST">
																@method('PUT')
																@csrf
																				...
																				<div class="form-group row">
																								...
																								<div class="col-md-8">
																												<input class="form-control @error('email') is-invalid @enderror" type="email"
																																placeholder="Enter your email " name="email" value="{{ $service->email }}"
																				...
																				<div class="form-group row">
																								...
																								<div class="col-md-8">
																												<input class="form-control @error('phone_number') is-invalid @enderror" type="number"
																																...
																																value="{{ $service->phone_number }}" autocomplete="phone_number" required>
																				...
																				<div class="row justify-content-center">
																								<div class="form-input" id="fill_other_requirement">
																												...
																												<textarea id="requirement" class="form-control  @error('description') is-invalid @enderror" type="text"
																												    placeholder="Enter your description here" name="description" autocomplete="description" required>{{ $service->description }}</textarea>
																												@error('description')
																																<span class="invalid-feedback" role="alert">
																																				<strong>{{ $message }}</strong>
																																</span>
