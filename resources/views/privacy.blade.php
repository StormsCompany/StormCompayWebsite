...
<body>
				...
				<ul>
								...
								<li>
												<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
																or
																&quot;Our&quot; in this Agreement) refers to Storms Company, MasaiLodge Rongai.</p>
								</li>
								<li>
								...
								<li>
												<p><strong>Website</strong> refers to Storms Company, accessible from <a href="https://storms.co.ke"
																				rel="external nofollow noopener" target="_blank">https://storms.co.ke</a></p>
								</li>
								<li>
				...
				<ul>
								<li>
												<p>By email: stormsco@storms.co.ke</p>
								</li>
								<li>
												<p>By visiting this page on our website: <a href="https://storms.co.ke/privacy"
																				rel="external nofollow noopener" target="_blank">https://storms.co.ke/privacy</a></p>
								</li>
								<li>
												<p>By phone number: +254714680763</p>
								</li>
				</ul>
