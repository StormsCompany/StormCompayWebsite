...
@section('content')
				...
				{{--  <div class="product_section layout_padding" data-aos="zoom-in">
								<div class="container">
												<h1 class="choose_text">Our clients</h1>
												<h2 class="tariffs_text">Who we work with</h2>
												<p class="lorem_text1">
																We work with clients from a wide range of fields from real estate to retails, farmers and microfinance.
												</p>
